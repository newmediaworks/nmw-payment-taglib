...
import static com.newmediaworks.taglib.payment.StateTag.TAG_NAME;
 ...
 */
public class StateTag extends EncodingBufferedBodyTag {

/* SimpleTag only:
	public static final String TAG_NAME = "<payment:state>";
/**/
...
/**/
		PropertyHelper.setAddressProperty(
			...
			PaymentTag::setCreditCardState,
			PaymentTag::setShippingAddressState
		);
/* BodyTag only: */
		return EVAL_PAGE;
/**/
