...
import static com.newmediaworks.taglib.payment.MerchantEmailTag.TAG_NAME;
...
/**
 * Provides the email address of the merchant to a {@link PaymentTag}.
 *
 * @see  TransactionRequest#setMerchantEmail(java.lang.String)
 *
 * @author  <a href="mailto:info@newmediaworks.com">New Media Works</a>
 */
public class MerchantEmailTag extends EncodingBufferedBodyTag {
  ...
  protected int doEndTag(BufferResult capturedBody, Writer out) throws JspException, IOException {
    ...
    PaymentTag.requireCurrent(TAG_NAME, pageContext.getRequest())
        .setMerchantEmail((value != null) ? value : capturedBody.trim().toString());
    /* BodyTag only: */
    return EVAL_PAGE;
    /**/
  }
