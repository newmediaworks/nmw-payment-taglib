 ...
 */
public class PurchaseOrderNumberTag extends EncodingBufferedBodyTag {

  /* SimpleTag only:
    public static final String TAG_NAME = "<payment:purchaseOrderNumber>";
  /**/
  ...
  protected int doEndTag(BufferResult capturedBody, Writer out) throws JspException, IOException {
    ...
    PaymentTag.requireCurrent(TAG_NAME, pageContext.getRequest())
        .setPurchaseOrderNumber((value != null) ? value : capturedBody.trim().toString());
    /* BodyTag only: */
    return EVAL_PAGE;
    /**/
  }
