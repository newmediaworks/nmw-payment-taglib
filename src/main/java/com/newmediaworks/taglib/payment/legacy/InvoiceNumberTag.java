...
import static com.newmediaworks.taglib.payment.InvoiceNumberTag.TAG_NAME;
 ...
 *
 * @see  TransactionRequest#setInvoiceNumber(java.lang.String)
 *
 * @author  <a href="mailto:info@newmediaworks.com">New Media Works</a>
 */
public class InvoiceNumberTag extends EncodingBufferedBodyTag {
  ...
  protected int doEndTag(BufferResult capturedBody, Writer out) throws JspException, IOException {
    ...
    PaymentTag.requireCurrent(TAG_NAME, pageContext.getRequest())
        .setInvoiceNumber((value != null) ? value : capturedBody.trim().toString());
    /* BodyTag only: */
    return EVAL_PAGE;
    /**/
  }
