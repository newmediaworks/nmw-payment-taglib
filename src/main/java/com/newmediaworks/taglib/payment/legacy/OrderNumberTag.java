...
import static com.newmediaworks.taglib.payment.OrderNumberTag.TAG_NAME;
...
/**
 * Provides the application-specific unique order number to a {@link PaymentTag}.
 *
 * @see  TransactionRequest#setOrderNumber(java.lang.String)
 *
 * @author  <a href="mailto:info@newmediaworks.com">New Media Works</a>
 */
public class OrderNumberTag extends EncodingBufferedBodyTag {

/* SimpleTag only:
	public static final String TAG_NAME = "<payment:orderNumber>";
/**/

	public OrderNumberTag() {
		init();
	}
...
/**/
		PaymentTag.requireCurrent(TAG_NAME, pageContext.getRequest())
			.setOrderNumber((value != null) ? value : capturedBody.trim().toString());
/* BodyTag only: */
		return EVAL_PAGE;
/**/
	}
