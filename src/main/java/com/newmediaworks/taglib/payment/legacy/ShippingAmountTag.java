...
import static com.newmediaworks.taglib.payment.ShippingAmountTag.TAG_NAME;
 ...
 */
public class ShippingAmountTag extends EncodingBufferedBodyTag {
...
/**/
    PaymentTag.requireCurrent(TAG_NAME, pageContext.getRequest())
      .setShippingAmount((value != null) ? value : capturedBody.trim().toString());
/* BodyTag only: */
    return EVAL_PAGE;
/**/
  }
