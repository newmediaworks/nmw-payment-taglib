...
import static com.newmediaworks.taglib.payment.CardCodeTag.TAG_NAME;
 ...
 */
public class CardCodeTag extends EncodingBufferedBodyTag {

/* SimpleTag only:
	public static final String TAG_NAME = "<payment:cardCode>";
/**/
...
/**/
		PropertyHelper.setCardProperty(
			...
			TAG_NAME,
			this,
			StoreCreditCardTag::setCardCode,
			PaymentTag::setCreditCardCardCode
		);
/* BodyTag only: */
		return EVAL_PAGE;
/**/
