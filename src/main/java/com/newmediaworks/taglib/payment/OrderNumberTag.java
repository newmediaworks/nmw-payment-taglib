...
public class OrderNumberTag extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
		String orderNumber = getBodyContent().getString().trim();
		PaymentTag paymentTag = (PaymentTag)findAncestorWithClass(this, PaymentTag.class);
		if(paymentTag!=null) {
			paymentTag.setOrderNumber(orderNumber);
		} else {
			throw new JspException("orderNumber tag must be within a payment tag");
		}
