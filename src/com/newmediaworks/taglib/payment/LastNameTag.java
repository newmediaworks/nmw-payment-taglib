...
/**
 * Provides a last name to either a <code>StoreCreditCardTag</code>, <code>CreditCardTag</code>, or <code>ShippingAddressTag</code>.
 *
...
public class LastNameTag extends BodyTagSupport {
    ...
    public int doEndTag() throws JspException {
        String lastName = getBodyContent().getString().trim();
        ...
        if(storeCreditCardTag!=null) {
            storeCreditCardTag.setLastName(lastName);
        } else {
            ...
            if(creditCardTag!=null) {
                ...
                paymentTag.setCreditCardLastName(lastName);
            } else {
                ...
                if(shippingAddressTag!=null) {
                    ...
                    paymentTag.setShippingAddressLastName(lastName);
                } else {
                    throw new JspException("lastName tag must be within a storeCreditCard tag, creditCard tag, or shippingAddress tag");
                }
            }
        }
