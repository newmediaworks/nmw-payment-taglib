...
/**
 * Provides a phone number to either a <code>StoreCreditCardTag</code> or <code>CreditCardTag</code>.
 *
...
public class PhoneTag extends BodyTagSupport {
    ...
    public int doEndTag() throws JspException {
        String phone = getBodyContent().getString().trim();
        ...
        if(storeCreditCardTag!=null) {
            storeCreditCardTag.setPhone(phone);
        } else {
            ...
            if(creditCardTag!=null) {
                ...
                paymentTag.setCreditCardPhone(phone);
            } else {
                throw new JspException("phone tag must be within either a storeCreditCard tag or a creditCard tag");
            }
        }
